...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder> {
    ...
    public HotelAdapter(Context context, List<BookingsModel> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.hotel_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.from.setText(attraction.getName());
        ...
        holder.itemView.setOnClickListener(v->{
            ...
            TextView location = bottomSheetView.findViewById(R.id.location);
            ...
            hotelName.setText(attraction.getName());
            time.setText("Dates: " + attraction.getDate());
            location.setText("Location: " + attraction.getFrom());
            description.setText("Pax: " + attraction.getPax());
            contact.setText("UserId: " + attraction.getUserId());
