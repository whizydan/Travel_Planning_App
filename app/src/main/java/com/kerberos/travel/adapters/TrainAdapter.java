...
import com.kerberos.travel.fragments.TicketDialog;
...
public class TrainAdapter extends RecyclerView.Adapter<TrainAdapter.ViewHolder> {
    ...
    public TrainAdapter(Context context, List<BookingsModel> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.train_view, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v->{
            new TicketDialog(mContext, attraction.getPrice(), attraction.getDate(), "Train Ticket").show();
        });
    }
